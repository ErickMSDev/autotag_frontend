...
import { getEmbedInfo } from '../store/vehicleRankingSlice';
...
function VehicleRanking() {
  ...
  const { embedInfo } = useSelector((store) => store.main.vehicleRanking);
...
export default withReducer('main', reducer)(VehicleRanking);
