...
import { getEmbedInfo } from '../store/vehicleAnalysisSlice';
...
function VehicleAnalysis() {
  ...
  const { embedInfo } = useSelector((store) => store.main.vehicleAnalysis);
...
export default withReducer('main', reducer)(VehicleAnalysis);
